...
<%@ page import="com.lms.librarymanagesystem.bean.Record" %>
            ...
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                        ...
                        <fieldset>
                            ...
                            <c:if test="${member!=null}">
                                <table width="100%"  class="cont"  >
                                    <tr>
                                        <td width="8%" class="run-right"> 会员编号</td>
                                        <td colspan="7"><input class="text" type="text" id="idNubmer2"  value = "${member.idNumber}"/>
                                            <input type="button" id="btnQuery2" value="确定" disabled style="width: 80px;"/>
                                            <input type="button" id="btnReturn2" value="批量归还" style="width: 80px;"/>
                                        </td>
                                        </td>
                ...
                <tr>
                    ...
                    <td width="51%" class="left_txt">
                        <img src="./Images/icon_mail.gif" width="16" height="11"> 客户服务邮箱：123@czu.cn<br />
                    </td>
                    <td>&nbsp;</td><td>&nbsp;</td>
                </tr>
            </table>
